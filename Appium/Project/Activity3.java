...
public class Activity3 {
	...
	public void googleTasks() throws InterruptedException {
		...
		// Enters Note
		wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.id("edit_note_text"))).sendKeys("This is my plan");
		// Enters Title
		...
		String noteName = driver.findElementById("index_note_title").getText();
			...
			System.out.println(
					"Note with title :" + noteName + " is added successfully");
